...
uv run pytest tests/test_posts.py::test_get_post_not_found -v
uv run pytest tests/test_posts.py::test_create_post_success -v
uv run pytest tests/test_posts.py::test_create_post_unauthorized -v
uv run pytest tests/test_posts.py::test_update_post_success -v
uv run pytest tests/test_posts.py::test_update_post_wrong_user -v
uv run pytest tests/test_posts.py::test_get_posts_with_pagination -v
"""
